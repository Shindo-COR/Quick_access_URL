...
sets: {
	...
	buttons: [
		...
		{ label: "駅メンエスpre", url: "https://pre.ranking-mensesthe.jp/", color: "#ff8489" },
		{ label: "メンズリラクdev", url: "https://dev.menesth.jp/", color: "#ff8489" },
		{ label: "メンズアロマdev", url: "https://dev.menesth-aroma.com/", color: "#ff8489" },
		{ label: "ネット予約dev", url: "https://dev.e-yoyaku.jp/", color: "#ff8489" },
		{ label: "ヒルズデリdev", url: "https://dev.ex-deli.jp/", color: "#ff8489" },
	]
	},
	myset1: {
	title: "CCA-XXXX",
	...
	title: "プルリクとデプロイ",
	buttons: [
		{ label: "プルリク作成", url: "https://ap-northeast-1.console.aws.amazon.com/codesuite/codecommit/repositories/eki-web/pull-requests/new/release/.../?region=ap-northeast-1", color: "#FF8DAB" },
		{ label: "Jenkins ココア", url: "https://jenkins.core-tech.jp/view/%E3%82%B3%E3%82%B3%E3%82%A2/job/imc_dev_cocoa_job/build?delay=0sec", color: "#61D4CA" },
	...
	buttons: [
		...
		{ label: "勤怠関連システム", url: "https://attendance.core-tech.jp/", color: "#FF8DAB" },
		{ label: "ジョブカン勤怠申請", url: "https://id.jobcan.jp/users/sign_in", color: "#61D4CA" },
		{ label: "ジョブカン打刻", url: "https://ssl.jobcan.jp/login/mb-employee-global?redirect_to=%2Fm%2Findex%2Findex", color: "#607D8B" },
		{ label: "グループセッション", url: "https://unification5.core-tech.jp/gsession/common/cmn002.do", color: "#61D4CA" },
	] 
	},
	myset4: {
	title: "マイセット１",
